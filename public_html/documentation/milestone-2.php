		...
		<h1>Personal Website Project:<br />Milestone 2a Documentation</h1>
			<header>
				...
				<div class="fourth">
					...
					<p>Next, I will display images or logos for the software, tool sets, and other skills I'm proficient in or have experience using, and probably add links to some certificates from Lynda, etc to show my dedication to learning.</p>
					<div class="desktop">
